...
public class FastBlur {
    ...
    public  Bitmap fastblur(Bitmap sentBitmap, int radius,ImageView imageView) {
        ...
        sentBitmap=Bitmap.createScaledBitmap(sentBitmap, getImageViewSize(imageView).width/3, getImageViewSize(imageView).height/3, false);
